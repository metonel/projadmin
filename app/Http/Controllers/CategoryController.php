...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pagini.categorii')->with('categories', $categories);
    }
    ...
    public function store(Request $request)
    {
        ...
        $category->save();
        return redirect('/category/create')->with('success', 'Categoria a fost adaugata');
    }
